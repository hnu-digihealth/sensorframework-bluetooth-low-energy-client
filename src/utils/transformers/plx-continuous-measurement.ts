...
export const PLXContinuousMeasurementCallback: BluetoothGATTCallback = (data: BluetoothGATTByteData) => {
    ...
    measurement = {...measurement, spO2, pr};
    ...
    if(spO2PRFastPresent){
        ...
        measurement = {...measurement, spO2Fast, prFast};
    ...
    if(spO2PRSlowPresent){
        ...
        measurement = {...measurement, spO2Slow, prSlow};
    ...
    if(deviceAndSensorStatusPresent){
        ...
        measurement = {...measurement, deviceAndSensorStatus};
        index += 3;
    ...
    if(pulseAmplitudeIndexFieldPresent){
        ...
        measurement = {...measurement, pulseAmplitudeIndex};
    }
