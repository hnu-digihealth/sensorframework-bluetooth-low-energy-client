...
export const WeightMeasurementCallback: BluetoothGATTCallback = (data: BluetoothGATTByteData) => {
    ...
    measurement = {...measurement, units, weight};
    ...
    if(bmiAndHeightPresent){
        ...
        measurement = {...measurement, bmi, height};
    }
