...
export const PLXFeaturesCallback = (data) => {
    ...
    if (measurementStatusSupportPresent) {
        ...
        */
        ...
        features = Object.assign({}, features, { measurementStatusSupport });
    }
    ...
    if (deviceAndSensorStatusSupportPresent) {
        ...
        features = Object.assign({}, features, { deviceAndSensorStatusSupport });
    }
    return features;
};
//# sourceMappingURL=plx-features.js.map