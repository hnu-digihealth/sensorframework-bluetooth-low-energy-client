...
export const TemperatureMeasurementCallback: BluetoothGATTCallback = (data: BluetoothGATTByteData) => {
    ...
    measurement = {...measurement, unit, temperature};
    index += 4;
    ...
    if(temperatureTypePresent){
        ...
        measurement = {...measurement, temperatureType};
